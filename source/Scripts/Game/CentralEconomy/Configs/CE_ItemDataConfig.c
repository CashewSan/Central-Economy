...
class CE_ItemData
{
	...
	[Attribute("3600", UIWidgets.EditBox, params: "0 3888000", desc: "Length of time (in seconds) for item to spawn upon removal")]
	int m_iRestock;
	...
	[Attribute("-1", UIWidgets.EditBox, params: "-1 100", desc: "Minimum quantity of item (only applies to weapon magazines/boxes, jerrycans fuel values, and vehicles fuel values)")]
